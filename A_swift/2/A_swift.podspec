...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ModulizationDemo/A_swift"
  ...
  s.source       = { :git => "https://github.com/ModulizationDemo/A_swift.git", :tag => s.version.to_s }
  ...
  s.source_files  = "A_swift/A_swift/**/*.swift"
